...
GRANT EXECUTE ON FUNCTION DBA.NEXT_VAL(IN AS_SEQUENCE VARCHAR(50) ) TO GERENTE;
GRANT EXECUTE ON FUNCTION DBA.CREATE_USERDB( IN v_username NAME, IN v_password TEXT) TO GERENTE;
GRANT EXECUTE ON FUNCTION DBA.DELETE_USERDB( IN v_username NAME) TO GERENTE;
GRANT EXECUTE ON FUNCTION DBA.ALTER_USERDB( IN v_old_username NAME, IN  v_new_username NAME, IN  v_password TEXT) TO GERENTE;
...
DROP INDEX IF EXISTS DBA.IDX_FUN_CPF;
CREATE INDEX IDX_FUN_CPF ON DBA.TB_FUNCIONARIOS USING btree( FUN_CPF );

DROP INDEX IF EXISTS DBA.IDX_FUN_FUNCAO;
CREATE INDEX IDX_FUN_FUNCAO ON DBA.TB_FUNCIONARIOS USING btree( FUN_FUNCAO );

CREATE EXTENSION pg_trgm;
DROP INDEX IF EXISTS DBA.IDX_FUN_NOME_GIN;
CREATE INDEX IDX_FUN_NOME_GIN ON DBA.TB_FUNCIONARIOS USING gin( FUN_NOME gin_trgm_ops );

DROP INDEX IF EXISTS DBA.IDX_VEN_HORARIO;
CREATE INDEX IDX_VEN_HORARIO ON DBA.TB_VENDAS USING btree (VEN_HORARIO);

-- Indices de chaves estrangeiras 

DROP INDEX IF EXISTS DBA.IDX_TB_PRODUTO_PRO_CODIGO;
CREATE INDEX IDX_TB_PRODUTO_PRO_CODIGO ON DBA.TB_ITENS USING btree( TB_PRODUTO_PRO_CODIGO );

DROP INDEX IF EXISTS DBA.IDX_TB_VENDAS_VEN_CODIGO;
CREATE INDEX IDX_TB_VENDAS_VEN_CODIGO ON DBA.TB_ITENS USING btree( TB_VENDAS_VEN_CODIGO );

DROP INDEX IF EXISTS DBA.IDX_TB_FORNECEDOR_FOR_CODIGO;
CREATE INDEX IDX_TB_FORNECEDOR_FOR_CODIGO ON DBA.TB_ITENS USING btree( TB_FORNECEDOR_FOR_CODIGO );

DROP INDEX IF EXISTS DBA.IDX_TB_FUNCIONARIOS_FUN_CODIGO;
CREATE INDEX IDX_TB_FUNCIONARIOS_FUN_CODIGO ON DBA.TB_VENDAS USING btree( TB_FUNCIONARIOS_FUN_CODIGO );
